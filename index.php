...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE MANAGEMENT SYSTEM <br> COMPUTER SCIENCE & ENGINEERING </h3>
        </div>
    </div>
</div>
<div id="myCarousel" class="carousel slide" data-ride="carousel" %>
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/Xavier-University-Bhubaneswar.jpg" alt="Chania" style="max-height: 650px; width:1500px ; border-radius: 8px; display: block; margin-left: auto; margin-right: auto; ">
        </div>

        <div class="item">
            <img src="assets/img/xub-campus-wide-view.jpg" alt="Chania" style="max-height: 650px; width: 1500px ; border-radius: 8px; display: block; margin-left: auto; margin-right: auto; ;">
        </div>

        <div class="item">
            <img src="assets/img/1_A2JYygbUkH1UsbggjUoENQ.webp" alt="Flower" style="max-height: 650px; width: 1500px ; border-radius: 8px; display: block; margin-left: auto; margin-right: auto; ">
        </div>

        <div class="item">
            <img src="assets/img/home-right-img.jpg" alt="Flower" style="max-height: 650px; width: 1500px ; border-radius: 8px; display: block; margin-left: auto; margin-right: auto; ">
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets\img\faculty\rudrasir.jpg" class="img-rounded"/>
                    <h3 align="center">Prof. Rudra Mohan Tripathy</h3>
                    <hr/>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/reg.jpg" class="img-rounded"/>
                    <h3 align="center">Fr. S. Antony Raj, S.J.</h3>
                    <hr/>
                    <h4 align="center">Registrar<br/>XIM University</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Fr. Antony R. Uvari, S.J.</h3>
                    <hr/>
                    <h4 align="center">Vice Chancellor<br/>XIM University</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4>Xavier City Campus, Plot No: 12(A),
                    Nijigada, Kurki, Harirajpur,
                    Puri, Bhubaneswar - 752050,
                    Orissa, India
                </h4>
                <h4><strong>Call:</strong> +91 674-237-7700 </h4>
                <h4><strong>Email: </strong>info@xim.edu.in</h4>
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1"
            ...
            <hr/>
            <div>
                <a href="https://www.facebook.com/welcome2ximuniversity/"> <img src="assets/img/Social/facebook.png" alt=""/> </a>
                <a href="https://www.instagram.com/xim_university/?hl=en"> <img src="assets/img/Social/download.jpg" alt="" height="80px" width="80px"/></a>
                <a href="https://twitter.com/xim_university?lang=en"> <img src="assets/img/Social/twitter.png" alt=""/></a>
            </div>
        </div>
