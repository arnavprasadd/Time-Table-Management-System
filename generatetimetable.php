    ...
    <div id="TT" style="background-color: #FFFFFF">
        <table border="2" cellspacing="3" align="center" id="timetable">
            ...
            <tr>
                ...
                <td style="text-align:center">12:30-02:00</td>
                <td style="text-align:center">02:00-03:00</td>
                <td style="text-align:center">03:00-04:00</td>
                <td style="text-align:center">04:00-05:00</td>
            </tr>
            <tr>
                <?php
                $table = null;
    ...
    function gendf() {
        ...
        doc.addHTML(document.getElementById('TT')), function () {
            doc.save('<?php
                    ...
                    ?>' + '.pdf');}}
            <script>alert("Downloaded")</script>
...
<!--<div id="footer"  &copy 2014 yourdomain.com | All Rights Reserved |  <a href="http://binarytheme.com" style="color: #fff" target="_blank">Design by : binarytheme.com</a>
-->
<!-- FOOTER SECTION END-->
